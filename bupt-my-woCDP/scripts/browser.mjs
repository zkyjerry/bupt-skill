...
export function ab(args, options = {}) {
  ...
  // my.bupt.edu.cn 仅支持 HTTP，需绕过 Chrome 的 mixed-content 限制
  cleanEnv.AGENT_BROWSER_ARGS = "--unsafely-treat-insecure-origin-as-secure=http://my.bupt.edu.cn";
  try {
    return execSync(cmd, {
      encoding: "utf-8",
...
const STATE_DIR = join(homedir(), ".bupt-my");
